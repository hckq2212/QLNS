...
const notificationController = {
  ...
  getAll: async (req, res) => {
    try {
      ...
      console.error('notification.getAll error', err);
  ...
  getByUserId: async (req, res) => {
    try {
      ...
      console.error('notification.getByUserId error', err);
      return res.status(500).json({ error: 'Internal server error' });
    }
  },
  ...
  countUnread: async (req, res) => {
    try {
      ...
      console.error('notification.countUnread error', err);
      return res.status(500).json({ error: 'Internal server error' });
    }
  },
  ...
  deleteReadNotifications: async (req, res) => {
    try {
      ...
      console.error('notification.deleteReadNotifications error', err);
      return res.status(500).json({ error: 'Internal server error' });
    }
  },
};
